...
class DataProviderInterface {
 public:
  ...
  typedef std::function<void(const RelativeDistanceData&)> RelativeDistanceInputCallback;
  ...
  inline void registerRelativeDistanceCallback(const RelativeDistanceInputCallback& callback) {
